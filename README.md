...
<html lang="tr">
  ...
  <body>
    <section id="main" class="center">
      ...
      <div class="user_info">
        <h1 class="user_name">Ahmet Unsal</h1>
    ...
    <section class="about center" id="About">
      ...
      <p>
        Selam! Ben Ahmet ve ben web & android geliştiricisiyim.<br />
        Tasarımdan çok çeşitli becerilere sahibim,<br />
        Kotlin + HTML + CSS + Javascript'e.
      </p>
    </section>
      ...
      <div class="container center">
        <div class="main_box center">
          <div class="icon center">
            <img src="echo_logo.png" width="150px"></img>
          </div>
          <div class="box">
            <h1>Solve Music</h1>
            <p>
              Bu projede, küçük bir müzik çalar uygulaması yaptım.
            </p>
            <div class="links">
              <a
                href="https://github.com/ahmetunsal/SolveMusic"
                target="_blank_"
        ...
        <div class="main_box center">
          <div class="icon center">
            <img src="dis.png" width="140px"></img>
          </div>
          <div class="box">
            <h1>Discord Bot</h1>
            <p>
              Küçük bir discord botu.
            </p>
            <div class="links">
              <a
                href="https://github.com/ahmetunsal/dicsjsmo5"
                target="_blank_"
                >Github Repo<i class="fas fa-arrow-right"></i
              ></a>
            </div>
        ...
        <div class="main_box center">
          ...
          <div class="box">
            ...
            <div class="links">
              <a
                href="https://github.com/ahmetunsal/ahmetunsal.github.io"
                target="_blank_"
                >Github Repo<i class="fas fa-arrow-right"></i
              ></a>
            </div>
    ...
    <footer class="center">
      ...
      <div class="social_media_icons">
        <a href="https://www.instagram.com/unsalahmey/" target="_blank_"
          ><i class="fab fa-instagram"></i
        ></a>
        <a href="https://github.com/ahmetunsal" target="_blank_"
